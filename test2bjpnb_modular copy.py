...
# image = cv2.imread("edited/frame126_edited.jpg")
# image = cv2.imread("edited/frame157_edited.jpg")
image = cv2.imread("vidframe/frame157.jpg")
...
# %%
# img = gray #cv2.imread("messi5.jpg", cv2.IMREAD_GRAYSCALE )
...
images = [blurred, lap, sobelX, sobelY, sobelCombined, canny]
...
# %%
plt.imshow(imutils.opencv2matplotlib(sobelCombined))
# %%
plt.imshow(imutils.opencv2matplotlib(sobelY))
...
im = image # load your image as a numpy array.
...
def bcd_lr(u, d,thickness=2,x1=x1,y1=y1,x2=x2,y2=y2, n=10, oorig=oorig):
	# # %%
	t=thickness
	pu = du
	pd = dd
